        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-8">
              ...
              <a href="https://www.linkedin.com/company/neomengage" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-smooth" aria-label="LinkedIn">
                <Linkedin size={20} />
              </a>
